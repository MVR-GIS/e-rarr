...
```{r proj risk pies, fig.align='center',fig.height=3.5, fig.width=7, message=FALSE, warning=FALSE, echo=FALSE}
...
risk_log_table|>
  ...
  kbl(format = "html", escape = F, col.names =c("","","Cost","Schedule","Performance"), align="llccc")|>
