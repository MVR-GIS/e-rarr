...
shinyApp(
  ui = fluidPage(theme = bslib::bs_theme(
    ...
    sidebarLayout(
      sidebarPanel(selectInput("districtInput", "Select District", choices=c(" ",RiskImpactTable$USACE_ORGANIZATION)
),selectInput("projectInput", "Select a project", choices=c(" ",RiskImpactTable$PROJECT_NAME.x)),
tags$h6("or"),
selectInput("p2Input", "Select a P2 Number", choices=c(" ",RiskImpactTable$P2_LOOKUP)),
