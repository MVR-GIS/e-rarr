...
library(usethis)
options(scipen = 999)
erisk_item <-utils::read.csv("./inst/app/data/erisk_item.csv")
risk_item_db<-data.frame(erisk_item)
erisk_project <- utils::read.csv("./inst/app/data/erisk_project.csv")
risk_project_db<-data.frame(erisk_project)
risk_transact <- utils::read.csv("./inst/app/data/erisk_project.csv")
risk_transact <- data.frame(risk_transact)
milestonedf<- utils::read.csv("./inst/app/data/risk_transact.csv")
...
header_name <- "risk_item$PROJECT_NAME.x," ",(risk_item$RISK_IDENTIFIER"
```
