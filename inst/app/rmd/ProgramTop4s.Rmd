...
RiskDeets <- risk_item_db |>
  dplyr::select("PROJECT_ID","P2_NUMBER","P2_SUB_IDENTIFIER","RISK_IDENTIFIER", "PROJECT_NAME","RISK_NAME","RISKCATEGORY","RISK_STATEMENT" ,"LIFECYCLEPHASENAME","MILESTONE","LIKELIHOOD","DISCIPLINE","PROB_OCCURRENCE", "PERFORMANCEIMPACT","PERFORMANCEIMPACT_IMPCT", "PERFORMANCE_RANK_DESC", "PERFORMANCEIMPACT_RISK_RANKING","COST_IMPACT_LOWEST","COST_IMPACT_MOSTLIKELY",
                "COST_IMPACT_HIGHEST","COST_RANK_DESC","COST_RISK_RANKING",
                "SCHEDULE_IMPACT_LOWEST","SCHEDULE_IMPACT_MOSTLIKELY",
