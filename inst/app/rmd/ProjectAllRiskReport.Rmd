...
erisk_project <- read_csv("../data/PROJECTLIST_FULL_03226024.csv")
...
risk_log_tables|>
  mutate(
    COST_RISK_RANKING = cell_spec(COST_RISK_RANKING,color=costcolor, align = 'c', background = costcolor),
    SCHEDULE_RISK_RANKING = cell_spec(SCHEDULE_RISK_RANKING,color=schedulecolor,align = 'c', background = schedulecolor),
    PERFORMANCEIMPACT_RISK_RANKING = cell_spec(PERFORMANCEIMPACT_RISK_RANKING,color=performancecolor, align = 'c', background = performancecolor) ) |>
