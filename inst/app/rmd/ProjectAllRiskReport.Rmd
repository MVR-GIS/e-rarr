...
risk_log_tables|>
  mutate(
    COST_RISK_RANKING = cell_spec("", align = 'c', background = costcolor,extra_css = "padding:8px; display: flex;"),
    SCHEDULE_RISK_RANKING = cell_spec("",align = 'c', background = schedulecolor,extra_css = "padding:8px; display: flex;"),
    PERFORMANCEIMPACT_RISK_RANKING = cell_spec("", align = 'c', background = performancecolor,extra_css= "padding:8px; display: flex;") ) |>
