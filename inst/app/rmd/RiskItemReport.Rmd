...
risk_item_db <- readr::read_csv("../data/erisk_item.csv",show_col_types = FALSE)
risk_project_db <- readr::read_csv("../data/erisk_project.csv",show_col_types = FALSE)
risk_transact <- readr::read_csv("../data/risk_transact.csv",show_col_types = FALSE)
milestone_df<- readr::read_csv("../data/phase_milestone.csv",show_col_types = FALSE)
risk_modeled<-readr::read_csv("../data/erisk_modeled.csv",show_col_types = FALSE)
risk_treatment<-readr::read_csv("../data/risk_treat.csv",show_col_types = FALSE)
=======
library(DT)
library(erarr)
library(usethis)
...
risk_treatment<-filter(risk_treat, risk_treat$PROJECT_NAME == params$projID, 
                       risk_treat$RISK_NAME_ID == params$riskID)
risk_model<-filter(risk_modeled, risk_modeled$PROJECT_ID == risk_item$PROJECT_ID, 
...
ranking = c("Opportunity", "Low", "Medium","High")
colors = c('rgb(31,120,180)','rgb(51,160,44)','rgb(255,127,0)','rgb(227,26,28)')
cost_values = c(monteframe$COST_PROBOPP,monteframe$COST_PROBLOW,monteframe$COST_PROBMOD,monteframe$COST_PROBHIGH)
schedule_values= c(monteframe$SCHEDULE_PROBOPP,monteframe$SCHEDULE_PROBLOW,monteframe$SCHEDULE_PROBMOD,monteframe$SCHEDULE_PROBHIGH)
performance_values = c(monteframe$OUTCOME_PROBOPP,monteframe$OUTCOME_PROBLOW,monteframe$OUTCOME_PROBMOD,monteframe$OUTCOME_PROBHIGH)
>>>>>>> main
...
=======
    title = list(text = paste(cost_label$ranking),font= list(size = 13, color=cost_label$colors)),
>>>>>>> main
    textinfo = 'none',
...
<<<<<<< HEAD
  ...
  add_pie(
    ...
    hoverinfo = 'label+percent',
=======
      text = c("Cost",paste("Mean:",formattable::currency(monteframe$COST_MEAN,digits = 0)))))|>
  add_pie(
    monte_pies,
    value = ~monte_pies$schedule_values,
    labels =~monte_pies$ranking,
...
=======
  ...
  layout(annotations = list(x=c(0.49,0.485), y=c(1.2,-0.15), xref="paper", yref = "paper", showarrow = F,
                                                text = c("Schedule",paste("Mean:", monteframe$SCHEDULE_MEAN,"Days")))) |>
  add_pie(
    monte_pies,
    value = ~monte_pies$performance_values,
    labels =~monte_pies$ranking,
...
=======
  ...
  pies<-monte_pie |>
    plotly::layout(title = "",
      ...
      # yref = "paper",
      # showarrow = F,
      # text = c("Cost", "Schedule", "Performance", paste("Mean:",formattable::currency(monteframe$COST_MEAN,digits = 0)),
      #          paste("Mean:", monteframe$SCHEDULE_MEAN,"Days"))))
>>>>>>> main
  pies
```
