...
RiskImpactTable<-erisk_ItemProj |>
  select("RISK_ID","RISK_NAME_ID","RISK_NAME","RISK_IDENTIFIER","P2_NUMBER.x", "PROJECT_ID",
         "PROJECT_NAME.x","P2_SUB_IDENTIFIER.x", "RISK_NAME","RISKCATEGORY", 
         "DISCIPLINE", 
...
subid_condit <- ifelse(params$p2sub != "", TRUE, FALSE)

```

```{r }

print("Project:",risk_item$PROJECT_NAME.x," ",(risk_item$RISK_IDENTIFIER))
      print(if(!subid_condit)({"Sub Id:",params$p2sub}))
