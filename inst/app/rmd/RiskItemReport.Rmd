...
monteframe =monteframe |> 
  mutate(
      'costcolor' = case_when(
        COST_RISKRANKING == 1 ~ 'rgb(31,120,180)',
        COST_RISKRANKING == 2 ~ 'rgb(51,160,44)',
        COST_RISKRANKING == 3 ~ 'rgb(255,127,0)',
        COST_RISKRANKING == 4 ~ 'rgb(227,26,28)'
      ),
      'schedulecolor' = case_when(
        SCHEDULE_RISKRANKING == 1 ~ 'rgb(31,120,180)',
        SCHEDULE_RISKRANKING == 2 ~ 'rgb(51,160,44)',
        SCHEDULE_RISKRANKING == 3 ~ 'rgb(255,127,0)',
        SCHEDULE_RISKRANKING == 4 ~ 'rgb(227,26,28)'
      ),
         'outcomecolor' = case_when(
        OUTCOME_RISKRANKING == 1 ~ 'rgb(31,120,180)',
        OUTCOME_RISKRANKING == 2 ~ 'rgb(51,160,44)',
        OUTCOME_RISKRANKING == 3 ~ 'rgb(255,127,0)',
        OUTCOME_RISKRANKING == 4 ~ 'rgb(227,26,28)'
      )
    )

ranking = c("Opportunity", "Low", "Moderate","High")
cost_values = c(monteframe$COST_PROBOPP,monteframe$COST_PROBLOW,monteframe$COST_PROBMOD,monteframe$COST_PROBHIGH)
cost_monte_table <- data.frame(ranking, cost_values)
schedule_monte_table <-data.frame(ranking,"schedule_values"= c(monteframe$SCHEDULE_PROBOPP,monteframe$SCHEDULE_PROBLOW,monteframe$SCHEDULE_PROBMOD,monteframe$SCHEDULE_PROBHIGH))
performance_monte_table<-data.frame(ranking,"performance_values" = c(monteframe$OUTCOME_PROBOPP,monteframe$OUTCOME_PROBLOW,monteframe$OUTCOME_PROBMOD,monteframe$OUTCOME_PROBHIGH))
...
monte_pie<-plot_ly() |>
  add_pie(
    cost_monte_table,
    value = ~cost_monte_table$cost_values,
    labels =~cost_monte_table$ranking,
    title = "Opportunity",
    textinfo = 'none',
    name = " ",
  ...
  add_pie(
    schedule_monte_table,
    value = ~schedule_monte_table$values,
    labels =~schedule_monte_table$ranking,
    title = "Opportunity",
    textinfo = 'none',
    name = " ",
  ...
  add_pie(
    performance_monte_table,
    value = ~performance_monte_table$values,
    labels =~performance_monte_table$ranking,
    title = "Low",
    textinfo = 'none',
    name = " ",
