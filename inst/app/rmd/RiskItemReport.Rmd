...
params: 
  riskID: "RLE-3 Real Estate Plan approval delayed"
...
milestone_df<- readr::read_csv("../data/milestonedf.csv")
...
monte_condit <- ifelse(nrow(monteframe>0),TRUE,FALSE)
...
<center>
```{r message=FALSE, echo=FALSE,warning=FALSE, eval= monte_condit, fig.height=1.75, fig.width=7}
