...
schedulecolumn <-   if (risk_item_table$NO_PERFORMANCE_IMPACT == 1) {
...
performancecolumn <- if (risk_item_table$NO_PERFORMANCE_IMPACT == 1) {
    "No performance impact is anticipated"
  } else {
    c(risk_item_table$PERFORMANCEIMPACT_DESC, risk_item_table$PERFORMANCEIMPACT,
...
knitr::kables(
  list(
    knitr::kable(
      costcolumn,
      format = "html",
      col.names = "Cost Impact"
    )|>
      kable_styling(), 
    knitr::kable(
      schedulecolumn,
      format = "html",
      col.names = "Schedule Impact"
    )|>
      kable_styling(),
    knitr::kable(
      performancecolumn,
      format = "html",
      col.names = "Performance Impact"
    )|>
      kable_styling()
  )
)
