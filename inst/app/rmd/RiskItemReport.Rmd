...
risk_item_table<- risk_item |>
  select(NO_COST_IMPACT,NO_SCHEDULE_IMPACT,NO_PERFORMANCE_IMPACT,COST_IMPACT_MOSTLIKELY, SCHEDULE_IMPACT_MOSTLIKELY,
         COST_IMPACT_LOWEST,COST_IMPACT_HIGHEST, COST_IMPACT_EVIDENCE,SCHEDULE_IMPACT_LOWEST, SCHEDULE_IMPACT_HIGHEST, SCHEDULE_IMPACT_EVIDENCE,PERFORMANCEIMPACT_DESC, PERFORMANCEIMPACT, PERFORMANCEIMPACT_DESC, SCHEDULE_IMPACT_DISTTYPE, COST_IMPACT_DISTTYPE)


tabletype <- if (risk_item_table$NO_COST_IMPACT == 1 &&
             risk_item_table$NO_SCHEDULE_IMPACT == 1 &&
             risk_item_table$NO_PERFORMANCE_IMPACT == 1) {
  "NoImpact"
} else if (risk_item_table$COST_IMPACT_DISTTYPE == 299 &
           risk_item_table$SCHEDULE_IMPACT_DISTTYPE == 299) {
  "PointImpact"
} else if (risk_item_table$COST_IMPACT_DISTTYPE == 306 &
           risk_item_table$SCHEDULE_IMPACT_DISTTYPE == 306) {
  "Uniform"
} else if (risk_item_table$COST_IMPACT_DISTTYPE == 302 &
           risk_item_table$SCHEDULE_IMPACT_DISTTYPE == 302) {
  "Triangle"
} 
```
...
#### **No Impact**
```{r echo=FALSE, eval= tabletype == "NoImpact"}
kbl(risk_item_table)
...
#### **Point Estimate**
```{r echo=FALSE, eval= tabletype == "PointImpact"}
PointTable<- risk_item_table |>
  select(COST_IMPACT_MOSTLIKELY,SCHEDULE_IMPACT_MOSTLIKELY,PERFORMANCEIMPACT)
...
#### **Uniform Example**
```{r echo=FALSE, eval= tabletype == "Uniform"}
kbl(risk_item_table)
...
```{r echo=FALSE, eval= tabletype == "Triangle"}
kbl(risk_item_table)
