aws-adfs login --adfs-host=sts1.cwbi.us --provider-id=urn:amazon:webservices:govcloud --region us-gov-west-1 --profile err-reports-test --role-arn arn:aws-us-gov:iam::379454761305:role/cwbi.us-DA-Planning-access-Test
